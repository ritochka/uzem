...
<div class="depcontent">
	<div class="row">
		...
		<div class="col-sm-12 hidden-xs" style="margin-bottom:20px;">
			<img src="/img/homepics/bootstrap-mdo-sfmoma-03.jpg" style="width:100%;" onerror="this.height=0">
		</div>
		...
		<div class="col-sm-4">
			...
			<ul class="dep-news-list">
				<li><a href="http://manas.edu.kg" target="_blank">{{{trans('default.KTMU')}}}</a></li>
				<li><a href="http://dep.manas.edu.kg" target="_blank">{{{trans('default.Departments')}}}</a></li>
		...
		<div class="col-sm-4">
			...
			<ul class="dep-news-list">
				...
				<li> 
					<a href="/course/courses/{{{ $course->code }}}"> {{{ $course->code }}} - {{{ str_limit($course->name, 45)  }}} </a>
				</li>
				@endforeach
			</ul>
			<div class="read-more">
